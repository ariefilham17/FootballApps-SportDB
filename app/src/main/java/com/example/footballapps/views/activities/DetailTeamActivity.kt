...
import com.example.footballapps.helpers.utils.BundleHelper.teamIdHelper
import com.example.footballapps.helpers.utils.BundleHelper.teamOverviewHelper
...
import com.example.footballapps.presenters.DetailTeamPresenter
import com.example.footballapps.presenters.FavoriteDetailTeamPresenter
import com.example.footballapps.views.adapters.FragmentViewPagerAdapter
import com.example.footballapps.views.fragments.TeamOverviewFragment
import com.example.footballapps.views.fragments.TeamPlayerFragment
...
class DetailTeamActivity : AppCompatActivity(), TeamView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pagerAdapter.addFragment(TeamOverviewFragment(), resources.getString(R.string.tab_team_overview))
        pagerAdapter.addFragment(TeamPlayerFragment(), resources.getString(R.string.tab_team_player))
        ...
        // -----------------------------------------------------------------------------------------
        swipeRefresh_teamDetail.onRefresh {
